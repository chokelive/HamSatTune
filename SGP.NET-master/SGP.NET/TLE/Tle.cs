    ...
    public class Tle
    {
        ...
        private void Initialize()
        {
            ...
            ExtractExponential(Line1.Substring(Tle1ColMeanmotionddt6,
                Tle1LenMeanmotionddt6), out _meanMotionDdt6, Line1);
            ExtractExponential(Line1.Substring(Tle1ColBstar,
                Tle1LenBstar), out _bstar, Line1);
        ...
        private static void ExtractExponential(string str, out double val, string line)
        {
            //24909-3
            //2.4909e-3
            //  .00000-E0
